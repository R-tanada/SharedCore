...
def initial_data_set():
	...
	job = input('役割を入力してください--> ')
	print(name+'さん , 役割: '+job)
	return name,job
...
def result(name,job,q,wwl):
	...
	path = 'C:/Users/24tak/OneDrive - 名古屋工業大学/学校/研究室/コード/data/TLX/'
	filename = path + 'PCT_TLX_' + name + '_' + job + '_' + now.strftime('%Y%m%d_%H%M') + '.csv'
