...
public:
  ...
  void fromAxis(const vector3d &xAxis, const vector3d &yAxis,
  ...
  vector3d toEulerZYX() const;

  void Slerp(const quaternion &q1, const quaternion &q2, float t,
             bool shortPath = 0);

  void Squad(float t, const quaternion &p, const quaternion &a,
             const quaternion &b, const quaternion &q, bool ueShortPath = 0);
