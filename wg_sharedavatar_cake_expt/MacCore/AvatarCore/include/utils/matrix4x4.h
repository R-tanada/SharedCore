...
class AvaUtils_API matrix4x4 {
   ...
   public:
    ...
    matrix4x4(float a11, float a12, float a13, float a14, float a21, float a22,
    ...
    void flagNotIdentity() { isIdentityMatrix = false; }
